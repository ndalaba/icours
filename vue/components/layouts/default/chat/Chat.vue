...
import Question from "~/components/layouts/default/chat/Question.vue";
import Response from "~/components/layouts/default/chat/Response.vue";
...
async function handleSubmit() {
  ...
  chats.value.push({isQuestion: true, question: question.value, response: ""})
  question.value = ""
  ...
  loading.value = false
  const modalBody = document.querySelector<HTMLDivElement>("#chat_body")
  if (modalBody)
